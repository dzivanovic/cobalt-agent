...
> **Note:** This document covers the Conversational Memory Layer (JSON-based). For the Quantitative Market Data Schema, see [[ADR-015 5-Pillar Relational Schema]] and [[PRD-013 Multidimensional Market Data Engine]].
