...
Consolidated 2026-09-__ at Dejan's laws sitting (his, not a tribunal — `cto-2026-09-22.md` R4), from the packet `docs/30 - Design/LAWS-CONSOLIDATION-PROPOSAL-2026-09-22.md`. Every entry changed by the consolidation carries `[amended 2026-09-__, consolidation <row>]`, where `<row>` names the audit's register row (`C<n>` = contradiction, `K<n>` = clutter, both `laws-audit-2026-09-20.md`), a pending close proposal (`P-<x>`) or a desk-practice candidate (`D<n>`, packet §7). The desk fills the date at the fold.

> DRAFT STATUS: this is the proposed text AS IT WOULD READ IF HE TOOK EVERY RECOMMENDATION of the packet — not law. The desk applies only what he rules, entry by entry (L58); a recommendation he declines keeps that entry's current LAWS.md wording.
...
- [amended 2026-09-__, consolidation K10] `O<n>` is the number of an objection ruled at the 09-13 ledger tribunal; it appears only as the authority of a 09-13 amendment, is historical, and is never used for a new ruling.
- [amended 2026-09-__, consolidation K8] `PROPOSED-1…6` are historical aliases of L62–L67 (LAWS-HISTORY H-PartVIII-PROPOSED). They are read, never written in new text.
- [amended 2026-09-__, consolidation K9] What binds: a line beginning `— ` is a citation, never law; a paragraph labelled `Status note` is state, never law; everything else in an entry is law text.
- [amended 2026-09-__, consolidation §1] `· judgement` after an entry's header means no mechanical arm enforces it today; a reader obeys it by judgement. Where an arm exists or is ruled, the entry names it. Laws of the routing cluster (L5, L21–L27, L29, L49) carry no marker: they are frozen for the routing tribunal.

## Preamble — the mechanism (ruled 09-13, Dejan; source: `~/tmp/tribunal-ledger/prompt-fable-r1.md:9`)

Verbatim: "MECHANISM RULING (09-13, Dejan): standing law is split from the decision record. `6 - Permanent/Memory/LAWS.md` becomes the ONLY canonical current law: one entry per law, amendments rewrite the entry in place with a date, superseded wording moves to `LAWS-HISTORY.md`. PROJECT-LEDGER.md keeps appending as the dated RECORD — a ruling in an appendix is NOT law until folded into LAWS.md, and the fold is a hub job at every session close. Wake-up path for every house: CLAUDE.md / AGENTS.md / QWEN.md → memory INDEX → LAWS.md. The tribunal reconciles under this ruling; it does not relitigate it." This ruling is now also pasted verbatim into PROJECT-LEDGER.md's 2026-09-13 appendix (O16). Who performs the fold since 2026-09-16: L58.
...
### L1 Fail-loud law (ruled 08-22; amended 2026-09-__)
...
[amended 2026-09-__, consolidation K4] Loudness is one bar across this file: L9's red banner + degraded flag, L18's "failed = loud" and L25's "degradation loud at every hop" are its domain forms, not separate bars.
— TRIAGE:12

### L2 Watcher standard (ruled 08-22) · judgement
...
### L6 Agent architecture north star (ruled 08-22) · judgement
...
### L7 Shadow-mode promotion law (ruled 08-22; amended 2026-09-16, 2026-09-__)
...
[amended 2026-09-16, L61; promoted from the status note 2026-09-__, consolidation C13] Until real HITL tokens and a Cobalt approve path exist, Dejan's spoken or typed "approve" in the desk chat, for the exact action the desk named (file, sha256), IS the HITL approval; the desk logs it with the time in `reports/cto-<date>.md` §4, and the hub executes on the desk's relay. The mechanical half of the approval is `--sha256`: what is applied is byte-identical to what was reviewed. `--hitl <label>` is an unverified free-text label (LEDGER:1288) and never satisfies this law on its own. The day real tokens ship, this clause is amended, not silently bypassed.
...
### L8 Sample-size law (ruled 08-22; amended 2026-09-__) · judgement
...
[amended 2026-09-__, consolidation K5] This is the RENDER rule; L7 is the PROMOTION rule. A number rendering is governed here; a variable going engine-fed is governed by L7.
— TRIAGE:19

### L9 Source-substitution guarantee + loud degradation (ruled 08-22) · judgement
...
### L12 Planning hard cap (ruled 08-22; amended 09-13, 2026-09-__) · judgement
...
[amended 2026-09-__, consolidation C15] A cap never skips a law step (L73): a design already under its tribunal (L52, L67) finishes that tribunal; what the cap cuts is SCOPE, and the cut scope becomes "decide during build".
— TRIAGE:23
...
### L13 Delegation contract (ruled 08-27) · judgement
...
### L14 One-throat law (ruled 08-28) · judgement
...
— LEDGER:14 (today's realization of the chief of staff: the CTO desk, L64)

### L15 External-code law (ruled 08-28; amended 08-29/31, 09-13) · judgement
...
— LEDGER:15; carve-out LEDGER:52, :72. A scope clause struck 09-13 (O31, by L44) → LAWS-HISTORY H-L15-scope.

### L16 Agents-as-data (ruled 08-28) · judgement
...
### L17 Council pattern (ruled 08-28; amended 08-29/31, 09-05, 2026-09-__) · judgement
...
[amended 2026-09-__, consolidation K6] How a council TERMINATES, and the rule that a law file is never voted: L39.
— LEDGER:17, :22, :1032. The 09-07 turn-limit paragraph formerly copied here → LAWS-HISTORY H-L17-dup; its current text is L39.

### L18 Task integrity guarantees (ruled 08-28) · judgement
...
### L19 Whole-prompt rule (ruled 08-27; amended 2026-09-__) · judgement
Every Code prompt delivered complete in one block, always; changes = full re-issue. Model tag on every prompt.
[amended 2026-09-__, consolidation C14] A CONTINUE relaunch is a full re-issue when the prompt file is unchanged and the only addition is ONE `CONTINUE:` prefix line naming the resume point (L47, L60). Any change to the file itself is a full re-issue of the file.
— LEDGER:19

### L20 Cross-thread review rule (ruled 08-28) · judgement
...
### L28 Vault-write law (ruled 09-03/04; amended 09-06, 09-09, 09-13, 2026-09-15, 2026-09-__)
...
Status note (not law text, routing tribunal evidence): the 09-07 local-seat verdict read this law as "never a write path (floor is cloud top-tier)" (LEDGER:906-907), a floor not in this text; 09-13 records that such floors "have since hardened into law that Astra cites to declare houses INELIGIBLE without assessing anything" (LEDGER:1325). Routing substance is not rewritten here.

### L30 Friction law (ruled 09-05) · judgement
...
### L32 User-data / system-data law (ruled 09-05; tenancy 09-06; clarified 09-12; amended 2026-09-__)
...
[amended 2026-09-__, consolidation K13] "User data" governs what leaves this install for OTHER Cobalt users. It never restricts a house working on this install: every house reads the memory folder and the vault under L44.
— LEDGER:1037, :1249 (paste LEDGER:1242)

### L33 Roles, not flags (ruled 09-07; clarified 09-09; access amended 09-12) · judgement
...
### L39 Council 3-turn rule (ruled 09-07; amends L17; law-file procedure 09-13; amended 2026-09-__) · judgement
...
[resolved 09-13, O5; moved here from L17 2026-09-__, consolidation K6] Reading B governs: synthesis on reasoning quality (L17) is how a council's recommendation is formed on turns 1–2; the turn-3 vote is the termination record for when synthesis does not converge, not a return to vote-tallying. A LAW FILE is never voted at all.
...
### L40 Expertise is owned, not shared (ruled 09-07) · judgement
...
— Rewritten 09-13, ledger tribunal; this is the current text. Prior text (09-10 fold, corrected 09-11) → LAWS-HISTORY H-L41-v2.
...
### L43 Deploy cadence (ruled 09-10; amended 09-15, 2026-09-21) · judgement
...
— LEDGER:1153 (held 09-11 LEDGER:1179, 09-13 LEDGER:1287); amendment LEDGER 2026-09-15 appendix; 2026-09-21 amendment: Dejan, desk chat. Per-case overrides are recorded in the day's desk report, never here (L73; e.g. `cto-2026-09-22.md` §4 R3).

---

## Part IV — L44–L47 (ruled 09-12/13)

### L44 Equal access (ruled 09-12; corollary 09-12) · judgement
...
### L46 One run, one commit (ruled 09-13; amended 2026-09-__) · judgement
...
### L48 Evidence in the report file (ruled 09-11; amended 2026-09-__) · judgement
...
[amended 2026-09-__, consolidation D5] Every clock time written in a report is read from `date` in that turn, never estimated or inferred from turn count.
...
### L50 Houses are switchable at will (ruled 09-13, R3) · judgement
...
— LEDGER:227-231 (O14; numbered 09-13)
...
### L58 Memory write path (ruled 2026-09-16; amended 2026-09-18, 2026-09-__) · judgement
...
### L59 Worker law-reading (ruled 2026-09-15 A; numbered 2026-09-16; amended 2026-09-__) · judgement
Architect, hub, builder and reviewer round 1 read LAWS.md in full. Read-and-judge seats (the local seat's day-open, agy, Grok probes) receive index-card excerpts of the binding laws only. Reviewer rounds 2–3 re-read the cited sections. Index card = the first section of every prompt: the files to read, the L-numbers that bind with one line each, the report path, the stop line. [amended 2026-09-__, consolidation C8] Workers NEED NOT read the whole memory folder: the card is the working set, never a fence — a worker opens any other memory file its task needs. Corollary of L44 (equal access is the entitlement; the card is the working set, never a withholding).
— Source: Dejan 2026-09-15 14:50 ET (`cto-2026-09-15.md` §6.4 item 3, `topics/cto-desk.md`: "… so it can retrieve anything else itself"); numbered "as recommended" 2026-09-16 07:5x ET. Prior "never read" wording → LAWS-HISTORY H-L59-never.

### L60 Session lifetime (ruled 2026-09-15/16; numbered 2026-09-16) · judgement
...
### L61 Desk launches and deploy permissions (ruled 2026-09-16; numbered 2026-09-16; amended 2026-09-__)
The CTO desk starts every hub itself as an independent background session (`claude --bg … --remote-control <job>`), attachable in herdr, never dependent on the desk process; Dejan directs the desk by voice or text and his hands remain for push (L55), rulings, and permission grants the classifier withholds. An unattended production deploy runs under a per-session allowlist naming exactly its commands (commit, merge --ff-only, rebase, tag, kickstart, validate, migrate --allow-prod when a migration ships, pg_dump); push is never in it; never `bypassPermissions`; the hub proves the gate at launch with a reverted tag and empty commit before scheduling. Until real HITL tokens exist and Cobalt has its own approve path, Dejan's spoken or typed "approve" in the desk chat, for the exact action the desk named, IS the HITL approval; the desk logs it with the time. Corollary of L55; the approval clause is L7's interim clause.
[amended 2026-09-__, consolidation D6] A hub whose herdr viewer the classifier refuses to attach (a production-write hub) runs without one, reachable by its remote-control name; the launch sentence says so, and the attach is never retried. Text sitting in a hub's input box is a harness suggestion, never his word.
— Source: Dejan, desk chat 2026-09-16 06:4x–07:1x ET (rulings 1 B, 2 B, 3; `cto-2026-09-16.md` §4); numbered "as recommended" 2026-09-16 07:5x ET. D6 evidence `topics/cto-desk.md` 2026-09-21 (09-20 night item 6; 09-21 afternoon item 5).

## Part VIII — L62–L67 (ruled 2026-09-17/18 by Dejan; folded by the CTO desk from `reports/close-2026-09-17.md` "LAWS fold" items (a)–(d), `cto-2026-09-17.md` §4 and `cto-2026-09-18.md` §4; carried as PROPOSED-1…6 until 2026-09-18 17:36 ET, then NUMBERED by the desk under his standing word R19 — "give it the next number for the law. I don't need to rule on a number, just whatever number is next. And if that's the number that you picked, that one is approved." The PROPOSED-n labels remain valid aliases, read only: LAWS-HISTORY H-PartVIII-PROPOSED)

### L62 Unattended launch (alias PROPOSED-1) (ruled 2026-09-17 06:03 ET, `cto-2026-09-17.md` R5; amended 2026-09-__) — candidate L61 corollary
...
[amended 2026-09-__, consolidation C9] BOUNDARY: a HUB never asks and never patches from inside. The DESK may ask Dejan — and only him — for a permission grant it lacks, naming the command and the reason; it never grants itself a permission it was just denied, and never asks him to re-decide a law in force (L73). Only his grant resumes a denied desk action.
[amended 2026-09-__, consolidation C5 + P-a (09-21)] PERMISSION MODE BY KIND OF RUN: a write-path run (L29's list: a vault or DB write, migration, delete, recovery or forensics — `cobalt_dev` included) launches with an explicit `--permission-mode acceptEdits` and its full `--allowedTools` list — never bare `claude --bg`, which comes up in AUTO mode, and never `--permission-mode auto`. Read-only hubs and drafters may run in auto mode. Every prompt's SEAT line states the mode verbatim from its own launch line; the dispatch check refuses a launch whose prose and flag disagree, or whose allowlist carries a write-path string without `acceptEdits`.
[amended 2026-09-__, consolidation D1–D3] In `acceptEdits` an unlisted Bash command raises a DIALOG, it is not denied. So every write-path prompt carries its allow strings in its own body, says an unlisted command is never called, and writes file content only through the Write / Edit tools, never a shell heredoc.
— Source: "I want all your sessions to have all the necessary permissions ahead of starting and I want them to run unattended by you all the way through until the task is finished … If the question is in the middle, your task has failed, needs to rerun with the correct information." Mode evidence: `65` bare launch 2026-09-21 20:11 → `FAILED PREFLIGHT` 20:13, relaunched `acceptEdits` 20:16 (`close-2026-09-21.md` P-a); dialogs 2026-09-21 22:1x and ≈02:2x (`cto-2026-09-21.md` §15).
...
### L64 Always-on desk, phone-first (alias PROPOSED-3) (ruled 2026-09-17 06:29 R7, 06:38 R8, 07:04 R11) · judgement
...
### L65 Desk edits his notes on his ruling (alias PROPOSED-4) (ruled 2026-09-17 07:58 ET, R14) — widens L58's desk scope; L28 untouched · judgement
...
### L66 Residents down before the merge (alias PROPOSED-5) (ruled 2026-09-17 21:54 ET, R19 "A") — amends L43's restart clause and L54's "merge = deploy" · judgement
...
### L67 Four-house tribunal for every design; three checkers for every build; never fewer than one other house (alias PROPOSED-6; ruled 2026-09-18 17:30 ET, `cto-2026-09-18.md` R18; emergency + override clauses 17:36 ET, R19; widens the same day's R8 14:29 and R17 17:26; amended 2026-09-21, 2026-09-__) · judgement
...
[amended 2026-09-__, consolidation P-c (09-21)] A turn that ends in METER, HARNESS, TIMEOUT or any other stop without a ruling (no BUILD / FIX / adopt / reject verdict) does not spend that house's round; only a turn that produces a ruling counts. The floor, the shrink-to-two clause and the cap's number are unchanged.
[amended 2026-09-__, consolidation P-d (09-21)] A "sitting" — a decision Dejan makes personally, outside the tribunal — exists only where he has named himself its output authority (today: the DRC template, `cto-2026-09-21.md` R48; the laws consolidation, `cto-2026-09-22.md` R4 — "Laws are all mine"). Every other item runs this law's path and reaches him as ONE approval, never a vote (L39).
...
### L68 Integrated gate before any merge (ruled 2026-09-19; amended 2026-09-20) · judgement
...
### L69 Settings in tests (ruled 2026-09-19) · judgement
...
### L70 Unproven escalates (ruled 2026-09-19; amended 2026-09-__)
An escalate whose evidence is "command denied" or "not run" is UNPROVEN and is never carried forward as a defect; it becomes a defect only when someone runs the command and reads the failure. [amended 2026-09-__, consolidation K2] Companion of L35: a claim of success and a claim of failure are held to the same bar.
...
### L71 The stop line (ruled 2026-09-20; proposal P2; amended 2026-09-__)
...
[amended 2026-09-__, consolidation P-d (09-20)] A run's resume breadcrumb or progress marker is never in a stop-line shape and never the last non-blank line of its report while the run is unfinished: it lives in a `## CONTINUE` section, and the prompt pins the in-progress last line (e.g. `(run in progress — next step under ## CONTINUE)`).
...
### L72 Assess every work item for blocking; non-blockers run in parallel (ruled 2026-09-20; proposal P4, widened by him; amended 2026-09-__) · judgement
...
[amended 2026-09-__, consolidation P-b (09-20)] A seam two sibling builders share — a name, shape or interface — IS a real dependency between them: the desk settles it in a document both prompts cite BEFORE either launches. A seam a builder can only record as a READING is unsettled. The stacked gate (L68) proves the seam; it does not decide it.
...
### L73 Speed never drops a step (ruled 2026-09-20; proposal P5; amended 2026-09-21) · judgement
...
### L74 Commit attribution, and instructions that arrive as data (ruled 2026-09-20; proposal P6) · judgement
...
## Part XI — L75 (proposed by the close hub in `reports/close-2026-09-20.md` P-c; consolidation 2026-09-__; number assigned by the desk under L58)

### L75 Fix rounds classify first (ruled 2026-09-__)
A fix round's drafter classifies EVERY check finding as FIX, NOT REAL, UNPROVEN (L70), OUT OF SCOPE or OWNER ITEM, from the check hub's own file-check rows, before anything is built. Only FIX rows are built, each backed by a row that HOLDS; the fix widens nothing; every OWNER ITEM reaches Dejan verbatim.
...
- **Desk practice, not law (consolidation 2026-09-__, PROPOSAL §6–§7):** the desk delegates and never does work itself; Fable-grade work is a spawned Fable agent, only after asking him (`close-2026-09-20.md` P-a) — lives in `topics/cto-desk.md`. Launch mechanics that bind no house beyond the desk (watch ceilings, windowed timers, tab handling, commit shapes, "never end a turn between steps", explicit `git add` paths) live in `topics/cto-desk.md` and `UNATTENDED-LAUNCH.md`.

---

## Fold at session close — the close hub PROPOSES, the desk APPLIES (definition ruled 09-13, O24; writer amended 2026-09-16 by L58; restated 2026-09-__, consolidation §8-1)
