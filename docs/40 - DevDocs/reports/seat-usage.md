...
|---|---|---:|---:|---:|---:|---:|
| `claude-opus-5` | claude · write seat — L29 floor for vault/DB/migration paths | 19,077,382 | 387,630 | 91,281 | $15.46 | — |
| `claude-sonnet-5` | claude · mechanical, non-write only — L29 ceiling for this tier | 26,527,080 | 1,184,937 | 357,306 | $13.62 | +$10.13 |
| `grok-4.6-build` | grok · build + research seat | 780,032 | 0 | 127,030 | $0.70 | — |
| `mainframe` | qwen · local lane (L23) — delegated mundane work, token conservation | 0 | 0 | 1,067 | $0.00 [^free] | $0.00 |
| `claude-fable-5-1` | claude · planning + architect seat — L29 above the floor, at Dejan's call | 38,934,171 | 455,022 | 145,353 | **unpriced** | — |
| `gpt-6-astra` | codex · reviewer seat — read-only role (L33) | 689,024 | 0 | 12,908 | **unpriced** | — |

**Day total (API-equivalent):** ≥ $29.78 · **89,622,930** tokens across 6 model(s), seats: claude, codex, grok, qwen
**Fresh input tokens:** 852,707 — not a column above because it is a rounding error beside cache reads, but it is priced into the dollar figures.
...
_Generated 2026-09-19 08:00 EDT by `seatusage.report` · ccusage 20.0.20 (MIT, pinned) · offline pricing, no network at run time._
