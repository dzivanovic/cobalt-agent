...
|---|---|---:|---:|---:|---:|---:|
| `claude-opus-5` | claude · write seat — L29 floor for vault/DB/migration paths | 574,171,456 | 6,574,622 | 1,815,792 | $395.02 | +$70.65 |
| `claude-sonnet-5` | claude · mechanical, non-write only — L29 ceiling for this tier | 307,884,828 | 9,960,859 | 3,068,339 | $126.32 | +$5.24 |
| `grok-4.6-build` | grok · build + research seat | 8,913,792 | 0 | 811,332 | $5.39 | +$0.42 |
| `claude-haiku-4-5-20251001` | claude · — | 62,123 | 55,061 | 435 | $0.12 | — |
...
| `gpt-6-astra` | codex · reviewer seat — read-only role (L33) | 7,506,304 | 0 | 49,573 | **unpriced** | — |

**Day total (API-equivalent):** ≥ $526.85 · **1,186,262,556** tokens across 7 model(s), seats: claude, codex, grok, qwen
**Fresh input tokens:** 4,436,056 — not a column above because it is a rounding error beside cache reads, but it is priced into the dollar figures.
...
_Generated 2026-09-19 15:00 EDT by `seatusage.report` · ccusage 20.0.20 (MIT, pinned) · offline pricing, no network at run time._
