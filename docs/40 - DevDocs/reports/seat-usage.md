...
|---|---|---:|---:|---:|---:|---:|
| `claude-opus-5` | claude · write seat — L29 floor for vault/DB/migration paths | 240,669,882 | 2,160,364 | 565,937 | $149.80 | — |
| `claude-sonnet-5` | claude · mechanical, non-write only — L29 ceiling for this tier | 31,987,063 | 247,202 | 116,249 | $8.55 | — |
| `grok-4.6-build` | grok · build + research seat | 182,656 | 0 | 1,116 | $0.03 | — |
| `mainframe` | qwen · local lane (L23) — delegated mundane work, token conservation | 0 | 0 | 129 | $0.00 [^free] | — |
...
**Day total (API-equivalent):** ≥ $158.38 · **293,759,514** tokens across 6 model(s), seats: claude, codex, grok, qwen
**Fresh input tokens:** 106,822 — not a column above because it is a rounding error beside cache reads, but it is priced into the dollar figures.
...
_Generated 2026-09-08 18:50 EDT by `seatusage.report` · ccusage 20.0.20 (MIT, pinned) · offline pricing, no network at run time._
