...
|---|---|---:|---:|---:|---:|---:|
| `claude-opus-5` | claude · write seat — L29 floor for vault/DB/migration paths | 151,294,811 | 2,377,671 | 567,834 | $113.63 | +$33.54 |
| `claude-sonnet-5` | claude · mechanical, non-write only — L29 ceiling for this tier | 42,949,223 | 878,282 | 235,414 | $14.46 | +$7.45 |
| `grok-4.6-build` | grok · build + research seat | 1,116,288 | 0 | 37,400 | $0.39 | $0.00 |
| `mainframe` | qwen · local lane (L23) — delegated mundane work, token conservation | 0 | 0 | 845 | $0.00 [^free] | $0.00 |
| `claude-fable-5-1` | claude · planning + architect seat — L29 above the floor, at Dejan's call | 60,487,891 | 1,270,428 | 203,845 | **unpriced** | — |

**Day total (API-equivalent):** ≥ $128.48 · **261,765,160** tokens across 5 model(s), seats: claude, grok, qwen
**Fresh input tokens:** 345,228 — not a column above because it is a rounding error beside cache reads, but it is priced into the dollar figures.
...
_Generated 2026-09-18 15:00 EDT by `seatusage.report` · ccusage 20.0.20 (MIT, pinned) · offline pricing, no network at run time._
