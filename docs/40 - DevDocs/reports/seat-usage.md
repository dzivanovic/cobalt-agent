...
|---|---|---:|---:|---:|---:|---:|
| `claude-opus-5` | claude · write seat — L29 floor for vault/DB/migration paths | 138,718,976 | 2,107,107 | 766,879 | $109.61 | $0.00 |
...
**Day total (API-equivalent):** ≥ $150.95 · **310,283,288** tokens across 5 model(s), seats: claude, codex, grok, qwen
**Fresh input tokens:** 648,383 — not a column above because it is a rounding error beside cache reads, but it is priced into the dollar figures.
...
_Generated 2026-09-16 20:00 EDT by `seatusage.report` · ccusage 20.0.20 (MIT, pinned) · offline pricing, no network at run time._
