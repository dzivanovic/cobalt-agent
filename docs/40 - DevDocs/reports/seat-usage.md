...
|---|---|---:|---:|---:|---:|---:|
| `claude-opus-5` | claude · write seat — L29 floor for vault/DB/migration paths | 84,061,365 | 1,011,294 | 282,901 | $59.22 | $0.00 |
| `claude-sonnet-5` | claude · mechanical, non-write only — L29 ceiling for this tier | 24,790,499 | 288,696 | 89,783 | $7.01 | $0.00 |
...
| `claude-fable-5-1` | claude · planning + architect seat — L29 above the floor, at Dejan's call | 23,008,386 | 510,643 | 97,677 | **unpriced** | — |

**Day total (API-equivalent):** ≥ $66.63 · **135,639,425** tokens across 5 model(s), seats: claude, grok, qwen
**Fresh input tokens:** 343,648 — not a column above because it is a rounding error beside cache reads, but it is priced into the dollar figures.
...
_Generated 2026-09-18 11:00 EDT by `seatusage.report` · ccusage 20.0.20 (MIT, pinned) · offline pricing, no network at run time._
